...
const ICON_192 = `<svg xmlns="http://www.w3.org/2000/svg" width="192" height="192" viewBox="0 0 192 192">
...
const ICON_512 = `<svg xmlns="http://www.w3.org/2000/svg" width="512" height="512" viewBox="0 0 512 512">
...
// Service Worker code as constant
...
<body>
  ...
  <div class="card" id="uploadCard">
    ...
    <div class="pending-list hidden" id="pendingList">
      ...
      <button class="upload-btn" style="margin-top: 0.75rem; margin-bottom: 0;" onclick="retrySync()" id="retryBtn">
